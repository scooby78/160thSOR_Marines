...
class SOR_MechCommand_M : SOR_Commander_M
{
	...
	displayName = "(M) Mechanised Commander W";
	uniformClass = "rhs_uniform_FROG01_wd";
	linkedItems[] =
	{
		"rhsusf_spc_light",
...
class SOR_Rifleman_ammo_M : SOR_Rifleman_M
{
	...
	weapons[] = {"160_arifle_MXM_Black_F_cco","hgun_P07_F","Throw","Put"};
	respawnWeapons[] = {"160_arifle_MXM_Black_F_cco","hgun_P07_F","Throw","Put"};
};
...
//		camouflage = 0.6;
//		threat[] = {1.2,0.2,0.2};
	weapons[] = {"160_arifle_MX_Black_F_specter","Throw","Put","Laserdesignator"};
	respawnWeapons[] = {"160_arifle_MX_Black_F_specter","Throw","Put","Laserdesignator"};
	Items[] =
	{
		Recon_Equip,
		Recon_Meds
...
class SOR_ReconJTAC_M : SOR_ReconLeader_M
{
	...
	weapons[] = {"160_arifle_MX_Black_F_eotech","Throw","Put","ACE_Vector"};
	respawnWeapons[] = {"160_arifle_MX_Black_F_eotech","Throw","Put","ACE_Vector"};
};
...
class SOR_Marksman_M : SOR_ReconLeader_M
{
	...
	weapons[] = {"160_srifle_DMR_05_blk_F_premier","Throw","Put","Laserdesignator"};
	respawnWeapons[] = {"160_srifle_DMR_05_blk_F_premier","Throw","Put","Laserdesignator"};
	Items[] =
	{
		Recon_Equip,
		Recon_Meds
...
class SOR_Spotter_M : B_spotter_F
{
	...
	weapons[] = {"160_arifle_MXM_Black_F_specter","Throw","Put","ACE_Vector"};
	respawnWeapons[] = {"160_arifle_MXM_Black_F_specter","Throw","Put","ACE_Vector"};
	Items[] =
	{
		"ACE_ATragMX",
		"ACE_Kestrel4500",
...
{
	vehicleclass = "SOR_Infantry_Support";
	displayName = "(I) HMG Rifleman M320 W";
	backpack = "Vanilla_SOR_GD_Pack_M";
};
...
{
	vehicleclass = "SOR_Infantry_Support";
	displayName = "(I) Mortar Carrier W";
...
{
	vehicleclass = "SOR_Infantry_Support";
	displayName = "(I) Mortar Rifleman M320 W";
	backpack = "Vanilla_SOR_GD_Pack_M";
};
